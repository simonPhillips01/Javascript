...
<head>
	...
	<!--[if lt IE 9]>
		<script src="https://oss.maxcdn.com/libs/htmls5shiv/3.7.2/html5shiv.min.js"></script>
...
<div class="navbar navbar-default navbar-fixed-top">
	<div class="container">
		...
		<div class="collapse navbar-collapse">
			<form class="navbar-form nav-bar right" method="post">
				<div class="form-group">
					<input type="email" name="loginemail" placeholder="Email" class="form-group" value="<?php echo addslashes($_POST['loginemail']); ?>" >
				</div>
				<div class="form-group">
