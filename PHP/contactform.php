<?php
	...
	if($_POST["submit"]) {
		...
		if ($error) {
			$result='<div class="alert alert-danger"><strong>There were error(s) in your form:</strong></div>';
		}
		else {
			if (mail("test@simoncodes.com", "Comment from website!", "Name: ".$_POST['name']."
				Email: ".$_POST['email']."
...
<body>
	...
	<?php
		...
		/*
		$emailTo = "simon.phillips@gmail.com";
		$subject = "Hi!";
		$body = "this is a test email";
		$header = "From: simon.phillips@gmail.com";
